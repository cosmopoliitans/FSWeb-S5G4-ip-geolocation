...
function ipAdresim(data) {
  ...
  newImg.src = "https://avatars.mds.yandex.net/i?id=98d9ae2ab1872a22c90c6f7df1201b82_l-5175093-images-thumbs&ref=rim&n=13&w=852&h=480";
  ...
  para1.textContent = "".concat(data.ülke, " (").concat(data.ülkeKodu, ")");
  cardInfo.appendChild(para1);
  var para2 = document.createElement("p");
  para2.textContent = "Enlem: ".concat(data.enlem, " Boylam: ").concat(data.boylam);
